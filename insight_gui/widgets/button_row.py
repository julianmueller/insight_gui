...
class ButtonRow(Adw.PreferencesRow):
    ...
    btn_content: Adw.ButtonContent = Gtk.Template.Child()
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if title:
            self.btn_content.set_label(str(title))
        ...
        if btn_icon_name:
            self.btn_content.set_icon_name(btn_icon_name)
    ...
    def filter_text(self) -> str:
        return self.btn_content.get_label()
