...
from insight_gui.models.interface_item import ActionInterfaceTypeItem
...
class ActionItem(GObject.GObject):
    ...
    interface = GObject.Property(type=ActionInterfaceTypeItem)
    ...
    def __init__(self, *args, interface_full_name: str, **kwargs):
        ...
        self.interface = ActionInterfaceTypeItem(full_name=interface_full_name)
