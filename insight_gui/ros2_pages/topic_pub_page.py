...
class TopicPublisherPage(ContentPage):
    ...
    def __init__(self, **kwargs):
        ...
        self.single_pub_btn = super().add_bottom_left_btn(
            label="Single Publish", icon_name="camera-photo-symbolic", func=self.on_single_pub
        )
        ...
        self.pub_text_view_row = self.pub_group.add_row(TextViewRow(editable=False, wrap_mode=Gtk.WrapMode.NONE))
    ...
    def on_topic_type_changed(self, *args):
        ...
        topic_type = self.topic_type_row.get_selected_item().get_string()
    ...
    def topic_callback(self, msg):
        ...
        if self.is_pubing or not self.single_pub_done:
